...
<div id="header">
	...
	*/
	...
	<h1 id="section-title">
	<img src="<?php echo $this->img ?>/logo.png" class="logo-g" alt="Guardia Ambiental Colombiana">	
	...
	<?php else: ?>
	<h1 id="site-name-lrg"><img src="<?php echo $this->img ?>/logo.png" class="logo-g" alt="Guardia Ambiental Colombiana">
	</h1>
	<?php endif; ?>
	</div>
</div>
...
<?php  admin_switch(); ?>
	<div id="userlinks">
		...
		<?php $path_parts = explode("/", $this->current_top_level_page); 
		    ...
		    <a href="" class="pref_wiz_launcher"><img alt="<?php echo _AT('preferences').' - '._AT('new_window'); ?>" title="<?php echo _AT('preferences').' - '._AT('new_window'); ?>"  src="<?php echo $this->img; ?>wand.png" class="img2222" style="margin-bottom:-.5em;"/></a> |
		    <?php } ?> 
