 ...
 * Description:       Un plugin que reemplaza el proceso del Login del WordPress con una pagina personalizada.
 * Version:           1.0.0
...
public static function plugin_activated() {
    ...
    $page_definitions = array(
        'member-login' => array(
            'title' => __( 'Entrar al sitio', 'personalize-login' ),
            'content' => '[custom-login-form]'
        ),
        'member-account' => array(
            'title' => __( 'Su Cuenta', 'personalize-login' ),
...
public function render_login_form( $attributes, $content = null ) {
    ...
    // 2. Check if user just logged out
